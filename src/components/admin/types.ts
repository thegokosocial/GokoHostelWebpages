...
export type ManagementTab = "dorms" | "users" | "backup" | "audit" | "logs" | "health" | "history" | "rates" | "menu" | "foodSettings" | "bulkUpload" | "qrGenerator" | "accountSettings" | "attendance" | "tasks" | "serverSync" | "channelManager" | "bookingSettings" | "website" | "analytics" | "quickLinks";
