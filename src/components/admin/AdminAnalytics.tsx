...
function MetricCard({ label, value, note, tone = "green", lens, delta }: { label: string; value: string; note?: string; tone?: "green" | "blue" | "amber" | "rose"; lens?: string; delta?: number | null }) {
  ...
  return <div className="min-w-0 rounded-2xl border border-brand-mist bg-white p-3 shadow-card dark:bg-card dark:shadow-none sm:p-4">
    ...
    <div className="mt-2 break-words text-xl font-bold text-brand-green-dark dark:text-zinc-100 sm:text-2xl">{value}</div>
