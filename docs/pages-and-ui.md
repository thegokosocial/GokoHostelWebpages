...
| `PwaInstallBanner.tsx` | registers `/sw.js` scope `/`; notification dialog always includes Install app guidance when not standalone; iOS enable gated to Home Screen app |
