...
| `bookings` | `booking-dashboard/` | `/api/admin/bookings`; nightly summaries show online, walk-in, blocked, and held-for-unassigned-OTA units; booking table headings remain pinned below the global admin header | `canViewBookings` |
