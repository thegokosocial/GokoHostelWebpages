...
| Source contracts | `src/__tests__/guest-booking-mobile.test.ts`, `src/__tests__/date-range-picker.test.ts`, `src/__tests__/cpu-lookup-checkin-workflows.test.ts`, `src/__tests__/self-checkin-soft-allow.test.ts`, `src/__tests__/self-checkin-workflow-e2e.test.ts` |
