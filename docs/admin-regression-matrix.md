...
| Food Orders | `food-orders`, food menu/settings | `food-tab-api-workflows`, `food-payment-allocation`, `food-payment-balance`, `food-bill-api`, `food-payment-d1.integration`, kitchen suites | place/edit/void/discount/pay/revert, preserve amount paid through additions/removals, partial vs full payment, oldest-first bill allocation, bank account selection, kitchen status, audit, role access |
