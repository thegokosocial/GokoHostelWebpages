...
| Food Orders | `food-orders`, food menu/settings | `food-tab-api-workflows`, `food-payment-allocation`, `food-payment-balance`, `food-order-editing-migration`, `food-market-pricing-admin`, `food-bill-api`, `food-payment-d1.integration`, kitchen suites | place/edit/void/discount/pay/revert, one-save batched edits, idempotent retries, preserve gross collection through additions/removals, exact audited refunds, stale payment-status recovery, all unpaid hostel/walk-in Combined Bill options, partial vs full payment, oldest-first bill allocation, bank account selection, kitchen status, audit, role access |
